      ...
      <div className="flex flex-col items-center justify-center text-center max-w-2xl w-full space-y-8">
        <div className="space-y-4">
          <h1 className="text-5xl md:text-7xl font-bold text-balance leading-tight">
            Developer & <span className="text-primary">Book</span> Lover
          </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link
            href="/book"
            className="inline-flex items-center justify-center px-8 py-3 border border-accent-foreground text-accent-foreground rounded-lg font-semibold hover:bg-accent-foreground/10"
          >
            Bookshelf
          </Link>
        </div>
